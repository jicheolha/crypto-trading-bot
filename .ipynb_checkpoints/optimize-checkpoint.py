...
SIGNAL_TIMEFRAMES = ['15min', '30min', '1h', '4h']
ATR_TIMEFRAMES = ['1h', '4h', '1d']
...
def main():
    ...
    total_combos = len(SIGNAL_TIMEFRAMES) * len(ATR_TIMEFRAMES)
    ...
    for i, signal_tf in enumerate(SIGNAL_TIMEFRAMES):
        for j, atr_tf in enumerate(ATR_TIMEFRAMES):
            combo_num = i * len(ATR_TIMEFRAMES) + j + 1
