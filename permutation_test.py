...
Method:
1. Run strategy on REAL data â†’ get actual performance metrics
...
def print_results(result: PermutationTestResult):
    ...
    if avg_p < 0.05:
        print("  âœ“ Your strategy's performance is unlikely due to random chance")
        print("  âœ“ The patterns it exploits appear to be real market structure")
        print("  âœ“ Proceed with cautious optimism (but always use proper risk management)")
    elif avg_p < 0.20:
        print("  âš  Results are inconclusive")
        print("  âš  Consider testing on different time periods")
        print("  âš  Try reducing parameters to avoid overfitting")
    else:
        print("  âœ— Your strategy performs similarly on random data")
        print("  âœ— The optimized parameters likely fit noise, not signal")
        print("  âœ— Consider simplifying the strategy or using different parameters")
